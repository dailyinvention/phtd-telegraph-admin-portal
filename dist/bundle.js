...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_is_function__ = __webpack_require__(22);
...
var modelServices_1 = __webpack_require__(31);
...
var mainContainer_1 = __webpack_require__(24);
...
var controls_1 = __webpack_require__(29);
var controlStore_1 = __webpack_require__(12);
var styled_components_1 = __webpack_require__(1);
var styles_1 = __webpack_require__(5);
var ContainerDiv = (_a = ["\n  background-color: ", ";\n  margin: 50px;\n  padding: 10px;\n  border-radius: 2px;\n"], _a.raw = ["\n  background-color: ", ";\n  margin: 50px;\n  padding: 10px;\n  border-radius: 2px;\n"], styled_components_1.default.div(_a, styles_1.styles.defaultPrimaryColor));
var ContainerH1 = (_b = ["\n  color: ", ";\n  font-size: 20px;\n  font-weight: normal;\n  font-family: ", ";\n"], _b.raw = ["\n  color: ", ";\n  font-size: 20px;\n  font-weight: normal;\n  font-family: ", ";\n"
    // Initial main container object
], styled_components_1.default.h1(_b, styles_1.styles.textPrimaryColor, styles_1.styles.fontFamily));
// Initial main container object
var MainContainer = /** @class */ (function (_super) {
    ...
    MainContainer.prototype.render = function () {
        ...
        return (React.createElement(ContainerDiv, null,
            React.createElement(ContainerH1, null, "Messages:"),
            React.createElement(messages_1.Messages, { controls: this.controls, store: this.store }),
            React.createElement(ContainerH1, null, "Controls:"),
...
var newMessage_1 = __webpack_require__(28);
...
], styled_components_1.default.br(_d));
// Messages container part
var Messages = /** @class */ (function (_super) {
    ...
    Messages.prototype.render = function () {
        ...
        return (React.createElement(MessagesContainer, null,
            React.createElement(newMessage_1.NewMessage, { store: this.props.store }),
            (this.messageList[0]) && this.messageList));
    };
    Messages = __decorate([
        mobx_react_1.observer
    ], Messages);
...
var styled_components_1 = __webpack_require__(1);
var styles_1 = __webpack_require__(5);
var StyledButton = (_a = ["\n  padding: 10px;\n  font-size: 16px;\n  margin: 10px 0px 10px 10px;\n  border-radius: 5px;\n  background-color: ", ";\n  color: ", ";\n  cursor: pointer;\n  border: 0px;\n  box-shadow: 1px 1px 1px #999;\n  font-family: ", ";\n  &:hover {\n    background-color: ", ";\n  }\n"], _a.raw = ["\n  padding: 10px;\n  font-size: 16px;\n  margin: 10px 0px 10px 10px;\n  border-radius: 5px;\n  background-color: ", ";\n  color: ", ";\n  cursor: pointer;\n  border: 0px;\n  box-shadow: 1px 1px 1px #999;\n  font-family: ", ";\n  &:hover {\n    background-color: ", ";\n  }\n"], styled_components_1.default.button(_a, styles_1.styles.darkPrimaryColor, styles_1.styles.textPrimaryColor, styles_1.styles.fontFamily, styles_1.styles.defaultPrimaryColor));
var StyledInput = (_b = ["\n  font-size: 14px;\n  padding: 10px;\n  height: 20px;\n  margin: 10px 0px 10px 10px;\n"], _b.raw = ["\n  font-size: 14px;\n  padding: 10px;\n  height: 20px;\n  margin: 10px 0px 10px 10px;\n"
    // Messages container part
], styled_components_1.default.input(_b));
// Messages container part
var NewMessage = /** @class */ (function (_super) {
    __extends(NewMessage, _super);
    function NewMessage() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.addMessageDisplay = false;
    ...
    __decorate([
        mobx_1.observable
    ], NewMessage.prototype, "addMessageDisplay", void 0);
...
var React = __webpack_require__(0);
var mobx_react_1 = __webpack_require__(3);
var control_1 = __webpack_require__(30);
var styled_components_1 = __webpack_require__(1);
var styles_1 = __webpack_require__(5);
var ControlsContainer = (_a = ["\n  background-color: ", ";\n  display: block;\n  padding: 10px;\n  margin: 10px 0px 0px 0px;\n  border-radius: 2px;\n  box-shadow: 1px 1px 1px #515151;\n  list-style: none;\n  && li {\n    font-family: ", "\n  }\n"], _a.raw = ["\n  background-color: ", ";\n  display: block;\n  padding: 10px;\n  margin: 10px 0px 0px 0px;\n  border-radius: 2px;\n  box-shadow: 1px 1px 1px #515151;\n  list-style: none;\n  && li {\n    font-family: ", "\n  }\n"
    // Messages container part
], styled_components_1.default.ul(_a, styles_1.styles.lightPrimaryColor, styles_1.styles.fontFamily));
// Messages container part
var Controls = /** @class */ (function (_super) {
    ...
    Controls.prototype.render = function () {
        ...
        return (React.createElement(ControlsContainer, null, (this.controlList[0]) && this.controlList));
    };
    Controls = __decorate([
        mobx_react_1.observer
    ], Controls);
...
var StyledInput = (_a = ["\n  font-size: 14px;\n  padding: 10px;\n  height: 20px;\n  margin: 10px 0px 10px 10px;\n"], _a.raw = ["\n  font-size: 14px;\n  padding: 10px;\n  height: 20px;\n  margin: 10px 0px 10px 10px;\n"
    // Messages container part
], styled_components_1.default.input(_a));
// Messages container part
        ...
        switch (this.props.type) {
            case 'number':
                this.controlComp = (React.createElement("label", null,
                    this.props.label,
                    " ",
                    React.createElement(StyledInput, { type: this.props.type, name: this.props.name, value: this.fieldValue, onChange: function (e) { return _this.handleChange(e); } })));
                break;
        }
