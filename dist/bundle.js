...
ReactDOM.render(React.createElement(mainContainer_1.MainContainer, { messages: modelServices_1.getMessages() }), document.getElementById("portal"));
...
var Messages = /** @class */ (function (_super) {
    ...
    Messages.prototype.render = function () {
        var messageList = this.props.messages.map(function (messageObj) {
            React.createElement(message_1.Message, null, messageObj.message);
        });
        return (React.createElement("ul", null, messageList));
    };
    return Messages;
}(React.Component));
...
function getMessages() {
    var returnedMessages = this.callPromise('GET', '/get-messages');
